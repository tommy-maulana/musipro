              ...
              AnimatedContainer(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        input(labelText: "Nama Depan", hintText: "Tommy"),
                        input(labelText: "Nama Belakang", hintText: "Maulana")
                      ],
                    ),
                    Row(
                      children: <Widget>[
                        input(
                            ...
                            hintText: "tommy@musipro.co"),
                      ],
                    ),
                    Row(
                      children: <Widget>[
                        input(
                            labelText: "Nomor Telpon", hintText: "62811367167"),
                      ],
                    ),
                    Row(
                      children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text(
                          "Saat daftar, Anda setuju dengan ",
